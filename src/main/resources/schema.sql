...
insert into users(user_id,email,password,role) values(1, 'admin', '$2y$12$3XeuDsPWJOWAnzCpGaOfCu6wUYHoHW/0OdfKhI8Jv8qnEaCsEPlMy', 'ROLE_ADMIN') on conflict (user_id) do nothing;
...
INSERT INTO users (user_id, email, password, role) VALUES (2206, 'b.szcze@yahoo.mail', '$2a$10$Q1eq5T8HGgFBSBTUqdgAwOD/fzRsLauUeqxot7u85R1lehrxqK4p2', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2216, 'a.sobczak@yahoo.mail', '$2a$10$9NsTGAs9bOvvSoGYSaKFcO.GX9jlEJI2T9fMMZDpwVObfx0q7/LWC', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2241, 'e.dabrowski@yahoo.mail', '$2a$10$PIKRGentZNNDCNFwu4t9LuTACT7wqlzSlDLC4xImBWHcc4LzjdSda', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2246, 'j.michalak@yahoo.mail', '$2a$10$G/pt5h4cbf6U2dMt5/unqudbvRP4yADy8y1cwyI/iNERrltPeEDxa', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2251, 'd.baran@yahoo.mail', '$2a$10$e.sTj5GWRcGldO2HHNJ76um17.s.QlVLprLgt9JX3.o1IZXqvO1pW', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2276, 'i.glowacka@yahoo.mail', '$2a$10$lhHzbIiWoVQxraSmmnxt7uL1hP/1Y9FX1fq7jSSfD/y8p4XWSzmlG', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2296, 'l.jakubowski@yahoo.mail', '$2a$10$Fap./ySQrwOqjSbb/6D0tO9AZymEpA9A1QWijqU6ybP6oAiWtlp62', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2301, 'd.maciejewski1@yahoo.mail', '$2a$10$hQQPV.BfG0x56hUCFESTme0u3emeKsQxQbBGQfuZ5MjR/jmBY9YQW', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2331, 'j.krajewska1@yahoo.mail', '$2a$10$ufKqjWl2c3FRhvHIqM7pR.85KBIt7uSFaaOdhRSLMy02LMvLtHp8O', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2336, 'a.sawicki@yahoo.mail', '$2a$10$2rWU4PlcjEvZkI0aMqc3zeK8Lj1yAsmAr25TiiiuZKpB472HeF3tu', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2306, 'k.zawadzki@yahoo.mail', '$2a$10$PMfiNFXPHQSj8zdYouFIquDY3QJc3J2Ryq7I75Bwz8S9mL6Ru/y3O', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2321, 'a.bak@yahoo.mail', '$2a$10$rj7E54Tjv9/pQn9AXenT2eA9LLtaMB3S78mukC4IQBwabHYiegkbq', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2236, 'a.chmielewski@yahoo.mail', '$2a$10$cJl./b09wG0kl2JpRFAsoOdNelYscblex80.iqWg3.aJ5GsywMUJG', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2311, 'k.zalewski@yahoo.mail', '$2a$10$MVTkiM40KOgC8qt1wZTFW.F4scAS9D9dlD2kdSDh6txTKlDZnT3PC', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2231, 'r.michalak@yahoo.mail', '$2a$10$wotxu1r63F0XzqiYA1ZDjOzKbw05VbTXlOPzA5Ny3bqcriLrJBioq', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2226, 'j.krajewska@yahoo.mail', '$2a$10$sms.1wrFhvQgdDfRqjVY6.xO07hF4YsSnv.VHrQiUo/4jpk1HnPM2', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2221, 'a.szymczak@yahoo.mail', '$2a$10$VqmZZf6caogCF8RHw3.8CujrOtAePdEsoryOqmk6pk3h9nzTgSQe6', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2346, 'c.sokołowski@yahoo.mail', '$2a$10$zlBeNup4c5n4ZJndoBgZd.aRkhFg87vNzHFMU4X9GlsBzljqfddGG', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2341, 'd.adamska@yahoo.mail', '$2a$10$KatKOeTRMwW6f19S3uH8veus4Q.NwYu07zXL4Y/LVmTy3YiunQ4Qq', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2326, 'a.piotrowski@yahoo.mail', '$2a$10$LJ.IQD30syBwXU8wIgs4EuL5g83ZTpg88bpOUJYtMmPgiruCQzdn2', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2351, 'k.czerwiński@yahoo.mail', '$2a$10$.3c8HWD2Q7Wu/rFb41/FueaVoEmJwfGP88hKrw0nTSMh9Dcb7M1pC', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2211, 'j.maciejewski@yahoo.mail', '$2a$10$mjb0ye4V.O/cWRW3qYHEz.ac.b.6Mzqrl7gRLk1la97D4lrEr9DoC', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2256, 'm.jakubowski@yahoo.mail', '$2a$10$VEwa.wZKiQsmLHPpTSrruuvRIASdKVR0LaOBe2zqI3CrqQUWmG5Bq', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2261, 'd.maciejewski@yahoo.mail', '$2a$10$BS6uBPVASAchfGKIHqVeH.a7rxiZnOGiFOnOHODaSwkinVkQL5u4e', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2271, 'd.kamiński@yahoo.mail', '$2a$10$S2Hi5ies5pKJXCSNPdEpx.iN4bBwTNnLNBfNyHRZoqwz81oATE9Ga', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2281, 'f.mroz@yahoo.mail', '$2a$10$Hqd1wIFLKwDJfA1kie5tGO7VyXTXLlTlKWjj55GBr7weLQz8YHulm', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2286, 'a.brzeziński@yahoo.mail', '$2a$10$7iqfreN6CatbD2EUu2RI7OG0tv/EIltwPIRV37w8rvvwj8KE6Q9zq', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2291, 'e.nowak@yahoo.mail', '$2a$10$JOxsPJTvwhZ6hS9UNdiCY.76GvviokrXaFvKwgeRMQSYmEUJK7Hai', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2266, 'k.jakubowski@yahoo.mail', '$2a$10$/1VvFLf4/n8CCZJBlkppXeioisDsp.Hx0dLmDkkP3WjnVy0Trjt.6', 'ROLE_STUDENT') on conflict (user_id) do nothing;
INSERT INTO users (user_id, email, password, role) VALUES (2316, 'k.nowak@yahoo.mail', '$2a$10$np2.lwbzNNZXmyrxrhGruu8X2e3DGnsiFC.nb4aA4f5cs4aQM96ri', 'ROLE_STUDENT') on conflict (user_id) do nothing;
...
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2515, 'Kacper', 'Andrzejewski', '596843209', 'pracownik', 'k.and@yahoo.mail', 2512) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2516, 'Denis', 'Lis', '778107281', 'pracownik', 'd.lis@yahoo.mail', 2512) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2523, 'Ariel', 'Sikora', '399330581', 'pracownik', 'a.sik@yahoo.mail', 2520) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2524, 'Kacper', 'Błaszczyk', '468290996', 'pracownik', 'k.blasz@yahoo.mail', 2520) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2530, 'Korneliusz', 'Baran', '627359854', 'pracownik', 'k.bar@yahoo.mail', 2527) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2535, 'Juliusz', 'Kaźmierczak', '917900926', 'pracownik', 'j.kaz@yahoo.mail', 2532) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2536, 'Jan', 'Sikorska', '700754846', 'pracownik', 'j.sik@yahoo.mail', 2532) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2543, 'Mariusz', 'Baranowski', '878007301', 'pracownik', 'm.bar@yahoo.mail', 2540) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2548, 'Konrad', 'Bąk', '525960787', 'pracownik', 'k.bak@yahoo.mail', 2545) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2549, 'Daniel', 'Przybylski', '701930447', 'pracownik', 'd.przb@yahoo.mail', 2545) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2550, 'Maurycy', 'Wróblewski', '118109740', 'pracownik', 'm.wrob@yahoo.mail', 2545) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2556, 'Karol', 'Michalak', '924740804', 'pracownik', 'k.mich@yahoo.mail', 2553) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2560, 'Marek', 'Ostrowski', '330712023', 'pracownik', 'k.ostr@yahoo.mail', 2557) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2564, 'Kacper', 'Włodarczyk', '756765917', 'pracownik', 'k.wlo@yahoo.mail', 2561) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2565, 'Allan', 'Sikora', '303035367', 'pracownik', 'a.sikr@yahoo.mail', 2561) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2566, 'Eryk', 'Sikorska', '756765917', 'pracownik', 'e.sikora@yahoo.mail', 2561) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2570, 'Bogumił', 'Szewczyk', '131000682', 'pracownik', 'k.szew@yahoo.mail', 2567) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2571, 'Heronim', 'Chmielewski', '964434480', 'pracownik', 'h.cmil@yahoo.mail', 2567) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2575, 'Robert', 'Zakrzewska', '472515472', 'pracownik', 'k.zakrz@yahoo.mail', 2572) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2576, 'Aleksander', 'Wójcik', '542699638', 'pracownik', 'a.woj@yahoo.mail', 2572) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2580, 'Alek', 'Wasilewska', '638194462', 'pracownik', 'k.wasil@yahoo.mail', 2577) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2581, 'Amir', 'Mazurek', '365088485', 'pracownik', 'a.maz@yahoo.mail', 2577) on conflict (guardian_id) do nothing;
INSERT INTO guardians (guardian_id, first_name, last_name, telephone_number, email, position, company_id) VALUES (2582, 'Bartłomiej', 'Urbańska', '496376941', 'pracownik', 'b.urb@yahoo.mail', 2577) on conflict (guardian_id) do nothing;
